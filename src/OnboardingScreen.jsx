...
const SLIDES = [
  {
    ...
    body:"池本市は、倉想空間と現実空間を「創造」で結ぶ実験都市です。市民として登録し、プロジェクトに参加・アセットを制作・購入することで都市の成長に貢献できます。",
  },
  {
    id:1,
    icon:"⋞",
  ...
  },
  {
    ...
    body:"市内の店舗が登録したアセット（作品・製品・ライセンス）を閲覧・購入できます。アセットには「CA指数」が設定されており、お気に入りの店舗をフォローすることもできます。",
  },
  {
    id:3,
    icon:"⊕",
    ...
    body:"表現者認可申請・アセット出力許可申請など、市民としての各種手続きができます。申請後は処理ログがリアルタイムで表示されます。",
  },
  {
    id:4,
    icon:"◉",
    ...
    heading:"マイページ",
    sub:"My Page",
    body:"市民証・EVI（存在価値係数）グラフ・参加中のプロジェクト・フォロー中の店舗・いいねしたアセットなどを一覧で確認できます。設定・サポート・法的情報もここからアクセスできます。",
  },
];
